      ...
      <Card className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 h-full border-none">
        ...
        <CardContent className="p-0">
          ...
          <div className="px-6 pt-6 pb-4 flex items-start gap-4">
            <div
              className={`w-12 h-12 rounded-lg bg-gradient-to-br ${getGradientClass(service.id)} flex items-center justify-center text-primary`}
            >
        ...
        <AnimatePresence>
          {isExpanded && (
            ...
            >
              <div className="p-6">
                <h4 className="font-montserrat font-bold mb-3 text-gray-800">
                  All Features:
                </h4>
