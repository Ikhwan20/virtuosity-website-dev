          ...
          >
            <motion.div variants={item} className="flex justify-center mb-10">
              <motion.img
                ...
                alt="Ren3 AI Logo"
                className="h-20 md:h-20 w-auto bg-white/10 backdrop-blur-sm rounded-full p-1"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-16">
            ...
            >
              ...
              <p className="text-gray-600">
                AI that acts independently to optimize workflows and complete
            ...
            >
              ...
              <p className="text-gray-600">
                Keep your data private and secure with on-premise deployment
                options and transparent data processing.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                From document analysis to productivity enhancement and sentiment
                analysis - Ren3 AI delivers measurable results.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                Communicate with your AI assistant in multiple languages,
                providing organization-wide intelligence across borders.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                How Ren3 AI Enhances Our Offerings
              </h2>
              <p className="text-lg text-gray-600 mb-8">
                Our partnership with Ren3 allows us to provide AI-powered
                solutions integrated into our consulting and automation
                services.
              </p>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-2">
                      AI-powered optimization of cloud workloads and
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-2">
                      Intelligent automation tools powered by AI to streamline
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-2">
                      Transform legacy applications with AI-driven insights and
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="z-10 text-center p-6">
                    ...
                    <p className="text-gray-700 mb-6">
                      Ren3 AI seamlessly integrates with Virtuosity's existing
                      solutions to deliver enhanced value.
                    </p>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl max-w-2xl mx-auto mb-10">
              Take the first step towards intelligent automation and AI-powered
              business transformation with Virtuosity and Ren3.
            </p>
