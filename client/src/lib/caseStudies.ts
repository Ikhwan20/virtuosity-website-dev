...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    background: "The client is a facility services conglomerate and is looking to evolve into a digital services driven organisation. Quick routes to market were identified such as monetising applications they developed for their daily operations as well as acquiring start-ups to grow their service offerings.",
    journey: "Our initial steps were to conduct a maturity assessment exercise on the client's digital delivery team, where we found areas for improvement, ranging from fundamental matters such as lack of Linux familiarity and manual tracking/logging of change request tracking/logging, to manual software delivery lifecycle without governed source control and release management."
  },
  {
    id: "fs",
